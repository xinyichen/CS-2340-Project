 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Xinyi");
		  toPrint += p1.toString("903013003");
		  //Person2 replace P2 with your name
		  //and gburdel2 with your gt id
		  Person2 p2 = new Person2("Ming");
		  toPrint += p2.toString("902903401");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Andrew");
		  toPrint += p3.toString("902826139");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Faye");
          toPrint += p4.toString("902915719");
          //Person5 replace P5 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Jesus");
          toPrint += p5.toString("902812640");
          //Person6 replace P6 with your name
          //and gburdell6 with your gt id
          Person6 p6 = new Person6("Jason");
          toPrint += p6.toString("902810754");
