...
$query="INSERT INTO deposit (username, account_name, amount, source, effective_date)
VALUES
('$_GET[username]','$_GET[account_name]','$_GET[amount]', '$_GET[source]', '$_GET[effective_date]')";
$r = mysqli_query($con,$query) or die("Error: ".mysqli_error($con));
