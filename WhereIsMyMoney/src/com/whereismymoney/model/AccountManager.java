...
public class AccountManager {
    ...
    public List<Account> getAllAccounts(String username) {
        List<Account> accountList = new ArrayList<Account>();
        	...
        	Document doc = DatabaseConnect.getDatabaseConnect().getAllAccounts(username);
    ...
    public boolean createAccount(String username, String account_display_name, String account_full_name, double balance, double interest_rate) {
    	...
    	Document doc = DatabaseConnect.getDatabaseConnect().createAccount( username,  account_display_name,  account_full_name,  balance,  interest_rate);
